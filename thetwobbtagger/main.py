...
def main():
    ...
    TB_train_df, TB_test_df, TB_train_scores, test_TB_scores = firstStage(train_TBs=trainTBs, test_TBs=testTBs, threshold=0.05, random_seed=42, chunk_size=200000)
    ...
    ET_train_df, ET_test_df = secondStage(train_ETs=trainETs, test_ETs=testETs, threshold=0.2, random_seed=42, chunk_size=100000)
